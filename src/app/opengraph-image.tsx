...
export default function OgImage() {
  return new ImageResponse(
    (
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", width: "100%", height: "100%", background: "#1f2a44", color: "white", padding: 80 }}>
        <div style={{ fontSize: 34, color: "#c08a2e", fontWeight: 700 }}>{brand.name}</div>
