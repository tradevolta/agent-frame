  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-14">
      <div className="max-w-2xl">
        <p className="text-sm font-semibold uppercase tracking-widest text-gold">Free tool</p>
        <h1 className="mt-2 font-display text-5xl font-semibold leading-tight">Free Just Listed graphic maker</h1>
